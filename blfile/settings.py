...
URL_WWW = getattr(settings, "FILEBROWSER_URL_WWW", '/media/projects/')

# The FileBrowser Admin-URL.
# Note: If you change this URL, you also have to change the file urls.py.
URL_ADMIN = getattr(settings, "FILEBROWSER_URL_ADMIN", '')
...
PATH_SERVER = getattr(settings, "FILEBROWSER_PATH_SERVER", os.path.join(settings.MEDIA_ROOT, 'projects'))
...
EXTENSIONS = getattr(settings, "FILEBROWSER_EXTENSIONS", {
    ...
    'Document':['.pdf','.doc', '.docx', '.rtf','.txt','.xls','.xlsx','.csv','.ppt','.pptx','.odt','.odp','.ods','.mpp', '.mpc', '.mpv', '.mmap'],
...
# Because of the low quality, its not intended to use this Thumbnail on your Website.
...
# When this is True, youll get a checkbox called "Use Image Generator" with every Upload-Field.
